...
HD_PWD='/home/ubuntu/caravel-soc_fpga-lab-main/lab-fir/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_tb.tcl
