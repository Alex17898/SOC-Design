...
HD_PWD='/home/ubuntu/caravel-soc_fpga-lab-main/Final/Final/lab-wlos_baseline/vivado/vvd_caravel_fpga/vvd_caravel_fpga.runs/design_1_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
